...
Widget _statTile(String l, dynamic v, IconData icon) => Builder(builder: (context) {
  ...
  child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
    ...
    Flexible(child: Text(v.toString(), style: TextStyle(fontWeight: FontWeight.bold, fontSize: 13, color: isDark ? Colors.white : Colors.black), textAlign: TextAlign.right)),
  ]),
);});
      ...
      child: Row(
        ...
        children: List.generate(pos.length, (i) {
          ...
          return Column(mainAxisAlignment: MainAxisAlignment.end, children: [
            Text("P${pos[i]}", style: TextStyle(fontSize: 7, color: isDark ? Colors.white38 : Colors.black38)),
            const SizedBox(height: 4),
