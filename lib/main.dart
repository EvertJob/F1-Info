...
class AppLocalizations {
  ...
  static final Map<String, String> _nlDictionary = {
    ...
    'partner': '❤️ Partner', 'pets': '🐾 Huisdieren',
    'children': '👶 Kinderen',
    'manager': '💼 Manager',
    ...
    'technical_director': '🛠️ Technisch Directeur',
  ...
  static final Map<String, String> _enDictionary = {
    ...
    'technical_director': '🛠️ Technical Director',
                  ...
                  child: Theme(
                    ...
                    child: ExpansionTile(
                      ...
                      title: Row(
                        ...
                        children: [
                          Row(children: [
                            Icon(Icons.history, size: 16, color: const Color(0xFF2196F3).withOpacity(0.7)),
                            const SizedBox(width: 12),
                            Text(loc.translate('previous_teams'), style: const TextStyle(color: Colors.white70, fontSize: 13)),
                          ]),
                        ],
                      ),
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Text.rich(
                                  TextSpan(
                                    children: [
                                      TextSpan(text: team, style: const TextStyle(color: Colors.white70, fontSize: 13)),
                                      if (years.isNotEmpty)
                ...
                child: Theme(
                  ...
                  child: ExpansionTile(
                    ...
                    title: Row(
                      ...
                      children: [
                        Row(children: [
                          Icon(Icons.score, size: 16, color: const Color(0xFF2196F3).withOpacity(0.7)),
                          const SizedBox(width: 12),
                          Text(loc.translate('total_points'), style: const TextStyle(color: Colors.white70, fontSize: 13)),
                        ]),
                        Text(widget.driver.totalPoints.toString(), style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 13, color: Colors.white)),
                      ],
                    ),
                    children: widget.driver.pointsPerSeason.entries.map((e) => Padding(padding: const EdgeInsets.fromLTRB(40, 4, 12, 4), child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [Text(e.key.toString(), style: const TextStyle(color: Colors.white54, fontSize: 12)), Text(e.value.toString(), style: const TextStyle(color: Colors.white, fontSize: 12))]))).toList(),
                  ),
                ),
              ),
      ...
      body: ListView(
        ...
        children: [
          ...
          ExpansionTile(
            ...
            children: [
              _statTile(loc.translate('team_principal'), "${team.principalName} (${team.principalAge})", Icons.person_outline),
              _statTile(loc.translate('technical_director'), "${team.technicalDirectorName} (${team.technicalDirectorAge})", Icons.engineering),
              _statTile(loc.translate('fastestPit'), "${team.fastestPitstopTime} (${loc.translate('country_${team.fastestPitstopCircuit}')} ${team.fastestPitstopYear})", Icons.build),
              const SizedBox(height: 8),
            ],
          ),
        ]
...
class Driver { 
  ...
  final int age; final String birthPlace; final String partner; final String pets; final String manager;
